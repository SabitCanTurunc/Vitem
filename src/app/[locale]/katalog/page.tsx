...
export default function KatalogPage() {
  ...
  async function handleRequest(e: React.FormEvent) {
    ...
    fd.append("message", t("request_message", { address }));
          ...
          <div className="max-w-2xl mx-auto">
            ...
            {requestStatus === "success" ? (
              ...
              >
                ...
                <h3 className="text-lg font-light text-vitem-900 mb-2">{t("request_received_title")}</h3>
                <p className="text-sm text-vitem-600 font-light">
                  {t("request_received_desc")}
                </p>
              </motion.div>
            ) : (
              <motion.form
              ...
              >
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-xs uppercase tracking-widest text-vitem-500">{t("label_name")}</label>
                    <input
                      required
                      type="text"
                      value={requestName}
                  ...
                  <div className="space-y-2">
                    <label className="text-xs uppercase tracking-widest text-vitem-500">{t("label_email")}</label>
                    <input
                      required
                      type="email"
                      value={requestEmail}
                ...
                <div className="space-y-2">
                  <label className="text-xs uppercase tracking-widest text-vitem-500">{t("label_address")}</label>
                  <textarea
                    required
                    rows={3}
                    value={address}
                ...
                >
                  ...
                  {requestStatus === "submitting" ? t("submitting") : t("submit")}
                </button>
              </motion.form>
            )}
          </div>
